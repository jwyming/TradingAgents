...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        deep_provider = (self.config.get("deep_llm_provider") or self.config.get("llm_provider", "")).lower()
        quick_provider = (self.config.get("quick_llm_provider") or self.config.get("llm_provider", "")).lower()
    ...
    def _get_provider_kwargs(self, provider: str) -> Dict[str, Any]:
        ...
        elif provider in ("openai", "openrouter", "xai", "ollama"):
